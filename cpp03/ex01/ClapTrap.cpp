...
ClapTrap::ClapTrap() : _points(100), _energy_points(50), _attack_damage(20) {
    std::cout << "Claptrap default constructor called " << std::endl; 
}

ClapTrap::ClapTrap(std::string name) : _name(name), _points(100), _energy_points(50), _attack_damage(20) {
